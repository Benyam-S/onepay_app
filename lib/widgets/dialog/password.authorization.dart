...
class PasswordAuthorizationDialog extends StatefulWidget {
  // Since the PasswordAuthorizationDialog interrupts a certain request flow we have to resume that flow if the validation is successful
  final Function callback;

  PasswordAuthorizationDialog(this.callback);

  _PasswordAuthorizationDialog createState() => _PasswordAuthorizationDialog();
}

class _PasswordAuthorizationDialog extends State<PasswordAuthorizationDialog> {
                        ...
                        Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                "For updating the selected sensitive data you have to enter "
                                "your password to authenticate your credential.",
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                onFieldSubmitted: (_) => _authorize(context),
                        ...
                        Row(
                          ...
                          children: [
                            CupertinoButton(
                              ...
                              onPressed:
                                  _loading ? null : () => _authorize(context),
                            ),
                            CupertinoButton(
                              child: Text(
                                "Cancel",
